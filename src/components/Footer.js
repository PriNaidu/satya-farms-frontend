        ...
        <>
            <footer className="text-center">
                <div className="container p-4">
                        ...
                        <form action="">
                            <div className="newsletter mb-5">
                                <div className="col-auto">
                                    ...
                                    <label className="form-label text-left d-flex" for="form5Example24" >Email address</label>
                                     <div className="d-flex wd-100 justify-content-center align-self-center">
                                     <input type="email" id="form5Example24" className="form-control subscribe-input" />
                                        <button data-mdb-ripple-init type="submit" className="btn btn-outline susbcribe-button">
                                        Subscribe
                                    </button>
                                     </div>
                 ...
                 <div className="footer-links-desc">
                 <section className="mb-4">
                        <p>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Sunt distinctio earum
                            repellat quaerat voluptatibus placeat nam, commodi optio pariatur est quia magnam eum
